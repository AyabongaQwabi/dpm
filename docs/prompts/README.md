...
Dated prompts for Claude Code / agent implementation passes. Read the linked prompt in full before coding.
...
| — | [pricing](pricing.md) | Commission brackets, ceiling packages, discount-unlock, price-change moderation |
| — | [customer-dashboard](customer-dashboard.md) | Customer account overview, bookings, messages, reviews, profile |
| — | [provider-dashboard](provider-dashboard.md) | Provider dashboard, services, sales, messaging |
