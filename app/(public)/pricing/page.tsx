...
export const metadata: Metadata = {
  title: "Provider Pricing — ServicePros",
  description: `List your service business for ${formatFee(PACKAGES[0].monthlyFee)}/month. Keep more of every rand you earn — commission caps, a loyalty rate bonus, and real business support. No surprises.`,
};
...
const BRACKETS = COMMISSION_BRACKETS.map((b) => {
  ...
  return {
    ...
    example: `R${examplePrice.toLocaleString("en-ZA")} job → you keep R${Number(kept).toLocaleString("en-ZA", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
  };
});
